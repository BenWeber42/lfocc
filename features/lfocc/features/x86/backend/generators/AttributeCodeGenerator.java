...
public class AttributeCodeGenerator {
	...
	public static String attribute(Variable variable, CodeGeneratorInterface codeGen) {
		String src = "";
	...
	public static String attributeAddress(Variable variable, CodeGeneratorInterface codeGen) {
		String src = "";
		RegisterManager regs = codeGen.getRegisterManager();
		assert variable.getDeclaration().extension(ScopeKind.class) == ScopeKind.CLASS_MEMBER;
